// API route removed: fetching is handled client-side now.
// This file is intentionally left without any exported HTTP handlers
// so that static exports (e.g. GitHub Pages) do not fail when building.
